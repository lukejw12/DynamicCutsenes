...
scoreboard players set #curve_height dynamic_cutscene.counter 32000
scoreboard players operation #curve_calc dynamic_cutscene.counter *= #curve_height dynamic_cutscene.counter
scoreboard players operation #curve_calc dynamic_cutscene.counter /= #1000 dynamic_cutscene.counter

scoreboard players operation #final_y dynamic_cutscene.counter += #curve_calc dynamic_cutscene.counter
