...
$data modify storage dynamic_cutscene:temp tag_test set value "$(current_tag)"
execute store success score #not_interpolated dynamic_cutscene.counter run data modify storage dynamic_cutscene:temp tag_test set value "interpolated"
execute if score #not_interpolated dynamic_cutscene.counter matches 0 run return 0
$data modify storage dynamic_cutscene:temp tag_test set value "$(current_tag)"
execute store success score #not_temp_particles dynamic_cutscene.counter run data modify storage dynamic_cutscene:temp tag_test set value "temp_particles"
execute if score #not_temp_particles dynamic_cutscene.counter matches 0 run return 0
