execute if score #display_index dynamic_cutscene.counter >= #cutscenes_found dynamic_cutscene.counter run return 0
...
function dynamic_cutscene:menu/display_cutscene_loop